...
const JingSiProductsSection = () => {
  ...
  return (
    <>
      {/* 上方灰色區塊 */}
      <div className="relative w-full bg-[#F2F2F2] flex flex-col items-center justify-center gap-2 px-5 py-8 sm:h-[310px] sm:px-0">
        {/* 左上裝飾圖 */}
        <img
          src="/images/jing_si_clip_left.png"
          alt="Left Decoration"
          className="absolute -left-6 top-0 h-36 w-36 sm:h-full sm:w-auto object-contain"
        />
        {/* 右下裝飾圖 */}
        <img
          src="/images/jing_si_clip_right.png"
          alt="Right Decoration"
          className="absolute -right-6 bottom-0 h-36 w-36 sm:h-full sm:w-auto object-contain"
        />

        <h3 className="mb-4 text-xl sm:text-2xl text-[#545454] z-10 text-center">「靜思」緣起</h3>
        <div className="flex flex-col items-center justify-center text-sm text-[#939295] z-10 gap-2">
          <p className="max-w-full sm:max-w-[968px] leading-relaxed text-center">
      ...
      <div className="my-20 mx-auto max-w-[1417px] w-full px-5 sm:px-0">
        ...
        {/* 商品內容 */}
        {/* 手機版：橫向滑動 */}
        <div className="flex sm:hidden mb-15 w-full overflow-x-auto pb-2">
        ...
        {/* 桌機版：原本 grid */}
        <div className="hidden sm:flex mb-15">
