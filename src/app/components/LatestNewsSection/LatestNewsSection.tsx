...
const activityList = [
  {
    ...
    date: "2025-5-18",
    position: "慈濟東大靜思堂",
    description: "癌症治療不必然只是痛苦的歷程，莊佳穎醫師將用淺顯易懂的方式，帶您了解癌症的成因、治療選擇及心理調適，讓您在面對疾病時能夠更有信心與勇氣。",
  ...
  },
  {
    ...
    date: "2025-6-10",
    position: "台北數位藝術中心",
    description: "在這場講座中，數位藝術專家將分享數位藝術的最新趨勢與技術，並探討如何利用數位媒介創作出引人入勝的藝術作品，讓參與者對未來的藝術形式有更深的理解。",
  ...
  },
  {
    ...
    date: "2025-7-15",
    position: "台北市立圖書館",
    description: "這是一個專為親子設計的共讀活動，透過精選的故事書，讓家長與孩子一起分享閱讀的樂趣，並進行互動討論，增進親子之間的情感聯繫，培養孩子的閱讀興趣。",
  ...
  },
  {
    ...
    date: "2025-8-20",
    position: "健康生活中心",
    description: "專業營養師將在這場講座中深入探討健康飲食的重要性，分享如何選擇營養均衡的食物，並提供實用的飲食建議，幫助參與者改善飲食習慣，提升生活品質。",
    image: "/images/activities/001.png",
  },
  {
    id: 5,
    ...
    date: "2025-9-25",
    position: "手作藝術館",
    description: "在這個工作坊中，參與者將學習如何使用簡單的材料創作獨特的手作藝術品，透過專業指導，激發創意，並享受手作的樂趣，適合所有年齡層的參與者。",
    image: "/images/activities/002.png",
  },
  {
    id: 6,
    ...
    date: "2025-10-30",
    position: "音樂廳",
    description: "這是一場結合音樂與心靈療癒的活動，透過輕柔的音樂，讓參與者在放鬆的氛圍中，釋放壓力，重拾內心的平靜，適合所有需要放鬆的人士參加。",
    image: "/images/activities/003.png",
  },
];
