  ...
  return (
    <>
      ...
      <div className="relative w-full h-[350px] bg-[#F2F2F2] flex items-center justify-center overflow-hidden">
        {/* 左上圓形裝飾 */}
        <img src="/images/jing_si_prue_cycle_left.png" alt="circle left" className="absolute left-0 top-0 z-10" />
        {/* 左側半圓裝飾 */}
        <img src="/images/jing_si_prue_left.png" alt="left decoration" className="absolute left-0 top-[70px]  z-10" />
        {/* 右上圓形裝飾 */}
        <img src="/images/jing_si_prue_cycle_right.png" alt="circle right" className="absolute right-0 bottom-0 z-10" />
        {/* 右側半圓裝飾 */}
        <img src="/images/jing_si_prue_right.png" alt="right decoration" className="absolute right-0 top-0 z-10" />
        ...
        <div className="max-w-[1417px] w-full flex items-center space-x-8">
          ...
          <div className="flex flex-col justify-center text-left max-w-[900px]">
            ...
            <div className="text-[#939295] text-base leading-7 space-y-2">
              <p>祝福力量大，對水說好話，會展現美麗的結晶，對米貼「謝謝」兩字，會散發出糯香味；</p>
              <p>
                靜思書軒，薏仁粉、薏豆粉、二十二味五穀粉…每一顆豆子，都是在佛號聲中歷練，那是來自靜思精舍師父們的祝福。
              </p>
              <p>靜思茶，新鮮茶葉切製，冷熱皆宜，從種茶的那一刻起，都是最虔誠的付出，那是來自大地的祝福。</p>
              <p>信念孕育生力量，我們相信每一人、事、物，都應該受到祝福。</p>
            </div>
          </div>
        </div>
      </div>
